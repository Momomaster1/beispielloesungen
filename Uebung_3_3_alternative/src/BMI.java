public class BMI {
	...
	public static void main(String[] args) {
		...
		double hoehe = 1.7;
		int alter = 65;
		boolean istm = true; // Wenn die Person maennlich ist =>True
		...
		// Festlegung der Grenzen fuer einen akzepablen BMI
		// Ausgangslage ist eine weibliche Person unter 25 Jahren
		// (Die habens am schwersten)
		int minbmi = 19;
		int maxbmi = 24;

		// Maennliche Personen koennen sich einen Punkt mehr erlauben
		// (Ist eine grds. Gesetzmaessigkeit, siehe Tabelle)
		if (istm) {
			minbmi = minbmi + 1;
			maxbmi = maxbmi + 1;
		}

		// Ist man aelter als 25, kann man sich einen Punkt mehr erlauben
		// (Ist eine grds. Gesetzmaessigkeit, siehe Tabelle)
		// gleiches gilt dann auch fuer 35,45,55,65
		if (alter >= 25) {
			minbmi = minbmi + 1;
			maxbmi = maxbmi + 1;
		}
