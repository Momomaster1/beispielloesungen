...
public class Spielkartenstapel {
	 ...
	 * @throws LeererKartenstapelException beim Ziehen von einem leeren Kartenstapel
	 */
	public Spielkarte getObersteKarte() throws LeererKartenstapelException {
		// Zuerst mal pruefen, ob der Stapel ueberhaupt noch Karten hat...
		if (aktuellObersteKarte < 0) {
			throw new LeererKartenstapelException();
		}
